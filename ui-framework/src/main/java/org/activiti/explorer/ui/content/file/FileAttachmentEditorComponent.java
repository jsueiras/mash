...
private Button okButton;
  ...
  private void initButton() {
	  ...
	  okButton = new Button(i18nManager.getMessage(Messages.RELATED_CONTENT_CREATE)+2);
	    addComponent(okButton);
	    setComponentAlignment(okButton, Alignment.BOTTOM_RIGHT);
  ...
  protected void saveAttachment() {
	     ...
	     CreateAttachmentPopupWindow window = getParentWindow();
	     window.saveAttachment();
	    
	  }

private CreateAttachmentPopupWindow getParentWindow() {
	CreateAttachmentPopupWindow window =	(CreateAttachmentPopupWindow) getParent().getParent().getParent();
	return window;
}
