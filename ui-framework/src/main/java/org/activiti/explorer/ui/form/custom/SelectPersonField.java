 ...
 */
public class SelectPersonField extends HorizontalLayout implements Field {
  ...
  public SelectPersonField(String caption) {
    ...
    selectUserButton.addListener(new ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        final SelectPersonPopupWindow window = new SelectPersonPopupWindow(
  ...
  public void setValue(Object newValue) throws ReadOnlyException, ConversionException {
    wrappedField.setValue((String) newValue);
