...
public class HistoricTaskDetailPanel extends DetailPanel {
  ...
  protected void initHeader() {
    ...
    // Add due date
    PrettyTimeLabel dueDateLabel = new PrettyTimeLabel(i18nManager,i18nManager.getMessage(Messages.TASK_DUEDATE_SHORT),
    ...
    // Add create date
    PrettyTimeLabel createLabel = new PrettyTimeLabel(i18nManager,i18nManager.getMessage(Messages.TASK_CREATED_SHORT),
