 ...
 * @author Joram Barrez
 */
public class SelectPersonPopupWindow extends PopupWindow {
  ...
  public SelectPersonPopupWindow(String title, boolean multiSelect) {
    this.title = title;
  ...
  public SelectPersonPopupWindow(String title, boolean multiSelect, Collection<String> ignoredUserIds) {
    this(title, multiSelect);
    this.ignoredUserIds = ignoredUserIds;
  }
  
  public SelectPersonPopupWindow(String title, boolean multiSelect, boolean showRoles, Collection<String> ignoredUserIds) {
    this(title, multiSelect);
...
protected void initSearchButton(HorizontalLayout searchLayout) {
